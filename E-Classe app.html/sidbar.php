...
<div class="sidnav vh-100 w-25" id="sidebar-wrapper">
      ...
      <div class=" d-flex justify-content-center ">
        <ul class=" list-unstyled hover">
          ...
          <li><a class="list-link" href="students.php"><i class="far fa-graduation-cap  py-md-2"></i>Students</a></li>
      
          <li><a class="list-link" href="payment.php"><i class="fal fa-usd-square py-md-2"></i> Payment</a></li>
      ...
      <span class="d-flex justify-content-center my-5 hover ">       
        <a class="list-link list-unstyled " href="sign-in.php"><i class="fal fa-sign-out-alt "></i> Log Out</a>   
       </span>
    </div>
