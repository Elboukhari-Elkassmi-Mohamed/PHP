            ...
            <div class="card">     
                  <div class="card-body ">
                    ...
                    <form class="mt-5"  action="process.php"  method="POST">        
                      ...
                      <a href="sign-Up.php"><button type="button"  class=" text-center col-12 " style="border:none; border-radius: 10px; background-color:darkseagreen;">Create new account</button></a>
